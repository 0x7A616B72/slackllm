...
class BedrockService:
    ...
    def invoke_model(self, messages, model_id=None):
        """
...
The current date is {datetime.datetime.now()} UTC.
...
Claude uses Slack markdown for code.
...
Claude keeps responses under 40,000 characters.
